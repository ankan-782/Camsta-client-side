                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-lg-6">
                            <div className="login-content-bg rounded-3 overflow-hidden">
                                ...
                                <form onSubmit={handleCustomLogin} className="px-3">
                                    <div className="mb-3">
                                        ...
                                        <input type="email" onBlur={getEmail} className="form-control login-input-bg py-3 rounded-3" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="abc@pqr.xyz" required />
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="password" onBlur={getPassword} id="inputPassword5" className="form-control login-input-bg py-3 rounded-3" aria-describedby="passwordHelpBlock" placeholder="Password" required />
                                    ...
                                    <div className="text-center">
                                        <button type="submit" className="btn btn-outline-dark rounded-3 mb-3">Login</button>
