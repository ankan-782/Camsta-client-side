...
const ProductsInHome = ({ product }) => {
    ...
    return (
        <div className="col">
            <div className="card products-in-home border-0 rounded-3 h-100">
                <img src={productImg} style={{ height: "250px" }} className="card-img-top rounded-3" alt="..." />
                <h5 className="card-title products-in-home-name rounded-end text-center m-0 py-2 text-white">{productName}</h5>
